<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="user-resumeA.aspx.cs" Inherits="WEB.client.user_resume" %>
					...
					<div class="panel panel-default resume-block">
						...
						<div class="panel-body shadow-effect">
							<div>
								...
								<span
									style="padding: 10px; background-color: #3872a4; margin: 0px 0 0 -15px; color: #fff;">编程综合表现</span>
								...
								<dl class="dl-horizontal">
									<dt>职业素质评价</dt>
									<dd>
										<span class="pull-center label label-primary">0.0 </span> <span
								...
								<dl class="dl-horizontal">
									...
									<dd>
										<span class="pull-middle label label-info">0.0 </span><span style="margin-left: 10px"
											class="label label-info">战胜了 
																		0
																	  %的人
								...
								<dl class="dl-horizontal">
									...
									<dd>
										<span class="pull-middle label label-primary">0.0 </span><span
											style="margin-left: 10px" class="label label-primary">战胜了
								...
								<dl class="dl-horizontal">
									...
									<dd>
										<span class="pull-middle label label-warning">0.0 </span> <span
								...
								<dl class="dl-horizontal">
									...
									<dd>
										<span class="pull-center label label-success">0.0 </span><span style="margin-left: 10px"
											class="label label-success">战胜了 
																		0
																	  %的人
			...
			<div class="col-md-3">
				<section id="Section1">
					<div class="panel-body shadow-effect">
						<!-- <h3><i class="fa fa-money"></i> 我的身价</h3> -->
						<span
							style="padding: 10px; background-color: #3872a4; margin: 0px 0 0 -15px; color: #fff;">我的身价</span>
					...
					<div class="panel-body shadow-effect" style="margin-top: 20px;">
						...
						<!-- <h3><i class="fa fa-money"></i> 我的身价</h3> -->
						<span
							style="padding: 10px; background-color: #3872a4; margin: 0px 0 0 -15px; color: #fff;">绑定信息</span>
						<p></p>
						<div class="col-md-4 center">
							
							
								<a href="#" id="sina" title="新浪微博" class="img-show"> <img
									src="../img/sina2.png">
								</a>
								...
								<div class="img-hide">
									<a target="_blank"
										href="https://api.weibo.com/oauth2/authorize?client_id=3064453059&response_type=code&forcelogin=true&redirect_uri=http://www.oxcoder.com/auth-sina.action">绑定</a>
						...
						<div class="col-md-4 center">
								...
								<a href="#" id="github" title="github" class="img-show"><img
									src="../img/github2.png"></a>
...
<!-- 										target="_blank">绑定</a> -->
										 <a
										href="https://github.com/login/oauth/authorize?client_id=cb26d4b4731db53e8a90&redirect_uri=http://www.oxcoder.com/auth-github.action"
										target="_blank">绑定</a>
								</div>
...
<!-- 						</div> -->
					...
					<div class="panel-body shadow-effect" style="margin-top: 20px;">
						...
						<!-- <h3><i class="fa fa-money"></i> 我的身价</h3> -->
						<span
							style="padding: 10px; background-color: #3872a4; margin: 0px 0 0 -15px; color: #fff;">基本资料</span>
						<h3>
							&#21513;&#35757;&#29020;
						</h3>
						<p>
							<span class="resume-label">性别:
								男
							</span><span class="resume-label">年龄:22
							</span>
						</p>
						<p>
							<span class="resume-label">手机:18811442520</span>
						</p>
						<p>
							<span class="resume-label">邮箱:12301100@bjtu.edu.cn</span>
						</p>
						<p class="pull-right">
							<a href="user-resume-operation.aspx"
								class="resume-action">编辑</a>
						</p>
					</div>
					<!-- /.panel-body -->
