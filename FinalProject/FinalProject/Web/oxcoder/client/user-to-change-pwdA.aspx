<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="user-to-change-pwdA.aspx.cs" Inherits="WEB.client.user_to_change_pwd" %>
	...
	<div class="container">
		<div class="row">
			<div
				...
				<div id="content">
					<div class="row">
						<form id="defaultForm" action="user-change-pwd.action" class="form-horizontal"
