<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="signupA.aspx.cs" Inherits="WEB.client.signup" %>
								...
								<div id="signin" class="panel-collapse collapse in">
									<div class="panel-body col-md-6">
										<ul class="nav nav-pills nav-justified"
											...
											<li id="li-work"
												class="active"><a
												href="#j2-home" data-toggle="pill">开发者</a></li>
											<li id="li-person"
												><a
												href="#j2-profile" data-toggle="pill">企业</a></li>
										</ul>
										<form action="signup-sub.aspx" method="post"
											...
											<div class="col-xs-12" style="margin-left: 20px;">
												<label> <input type="checkbox" id="agreement"
													name="check"> <small>我已阅读并同意<a
														href="oxcoder_license.aspx" target="_blank">《oxcoder用户协议》</a></small>
											...
											<div class="col-xs-12">
												<button type="submit" class="btn btn-primary btn-lg"
													style="margin-left: 20px; border-radius: 3px;">注册</button>
											</div>
