<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="enterprise-lookupsumeA.aspx.cs" Inherits="CreatePage.oxcoder.enterprise.enterprise_lookupsume" %>
		...
		<div class="row">
			<div class="col-md-12" id="print">
				<section id="middle">
					...
					<small>  
							<a
								href="hr-recruit-resume-list.aspx"><i
					...
					<div class="panel panel-default resume-block">
						...
						<div class="panel-body">
							...
							<h3>
								<i class="fa fa-trophy"></i>
								 本次挑战结果：
									...
									<span class="text-warning">未完成</span>
							...
							<h4>
								<span style="margin-left: 20px;">共用时：0分0秒
								</span> <span style="margin-left: 20px;">战胜了0.0%的人
								</span>
							</h4>
					...
					<div class="panel panel-default resume-block">
						...
						<div class="panel-body">
							...
							<h3></h3>
									...
									<li class="btn btn-alt btn-primary" style="margin-right: 15px;">&#20108;&#20998;&#26597;&#25214;</li>
								
									<li class="btn btn-alt btn-primary" style="margin-right: 15px;">&#24037;&#21378;&#27169;&#24335;</li>
								
									<li class="btn btn-alt btn-primary" style="margin-right: 15px;">&#24402;&#24182;&#25490;&#24207;</li>
							...
							<div class="panel-body">
								...
								<dl class="dl-horizontal">
									...
									<dd style="font-size: 20px; font-weight: 600;">
										<span class="text-primary">6930</span>元
									</dd>
								</dl>
								<dl class="dl-horizontal">
									<dt>职业素质评价</dt>
								...
								<dl class="dl-horizontal">
									...
									<dd>
										<span class="pull-middle label label-info">0.0 </span><span
								...
								<dl class="dl-horizontal">
									...
									<dd>
										<span class="pull-center label label-success">0.0 </span><span
									...
									<i class="fa fa-file"></i> 基本信息
										...
										<p>
											<span class="resume-label">性别：
												男</span> <span
												class="resume-label">年龄：22</span>
										</p>

										<p>
											<span class="resume-label">手机：18811442520</span><span class="resume-label">邮箱：12301100@bjtu.edu.cn</span>
										</p>
