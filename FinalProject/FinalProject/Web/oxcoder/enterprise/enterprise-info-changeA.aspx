<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="enterprise-info-changeA.aspx.cs" Inherits="CreatePage.oxcoder.enterprise.enterprise_info_change" %>
...
<script type="text/javascript">
					...
					<div class="row">
					   <font color="red"></font>
						<form id="defaultForm" method="post" class="form-vertical"
							action="enterprise-info-change-step2.aspx"
							enctype="multipart/form-data">
							<input id="input-provincework" type="hidden"
								value="&#21271;&#20140;" /> <input
								id="input-citywork" type="hidden"
								value="&#19996;&#22478;&#21306;" /> <img
								src="../img/corp_step1.png">

							<div class="form-group">
								<label><h3 class="grey">公司全称</h3></label> <input disabled
									type="text" id="corp-name" name="cname" class="form-control"
									placeholder="请输入公司全称"
									value="&#24187;&#32701;&#24037;&#20316;&#23460;">
							</div>

							<div class="form-group">
								<label><h3 class="grey">公司简称</h3></label> <input type="text"
									id="corp-sname" name="cnameshort" class="form-control"
									placeholder="请输入公司简称"
									value="&#24187;&#32701;"> <span
							...
							<div class="form-group">
								<label><h3 class="grey">公司LOGO</h3></label> <input type="file"
									name="image" tabindex="-1"
									style="position: fixed; left: -500px;" id="corp-pic"
									accept="image/*"> <span class="text-danger" id="error2"
									style="display: none;">请上传公司logo</span> <span
									class="help-block" id="hint2"></span>
							</div>

							<div class="form-group">
								<label><h3 class="grey">公司网址</h3></label> <input type="text"
									id="" name="website" class="form-control" placeholder="请输入公司网址"
									value=""> <span
									class="help-block">非必填</span>
							</div>
							<div class="form-group">
								<label><h3 class="grey">所在城市</h3></label>
								<div id="warp">
									<select name="prov" id="province" class="form-control"
										style="width: 200px; display: inline-block;">
										<option value="载入中">载入中</option>
									</select> <select name="city" id="city" class="form-control"
										style="width: 200px; display: inline-block;">
										<option value="载入中">载入中</option>
									</select>
								</div>
							...
							<div class="form-group">
								<label><h3 class="grey">公司规模</h3></label> <select name="scale"
									class="form-control" id="corp-big">
									<option value="">请选择</option>
									<option value="1" selected>少于15人</option>
							...
							<div class="form-group">
								...
								<textarea id="corp-info" name="cdes" rows="9"
									class="form-control" placeholder="请详细描述公司简介、企业文化等">UI &#35774;&#35745;
								</textarea>
								<span class="help-block" id="hint4" />
							</div>
							<div class="form-group form-actions pull-right">
								<button type="submit" class="btn btn-new1 btn-lg"
									style="border-radius: 3px;">保存&下一步</button>
							</div>
						</form>
					</div>
					<!-- /.row -->
	...
	<script type="text/javascript">
	    ...
	    $(function () {
	        ...
	        if ($("#input-provincework").val() != ""
					&& $("#input-citywork").val() != "") {
	            $("#province").val($("#input-provincework").val());
	            $("#province").change();
